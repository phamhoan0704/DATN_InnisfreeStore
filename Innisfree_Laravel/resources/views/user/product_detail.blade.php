    ...
    <div class="container">
        <div class="wapper">
            ...
            <div class="w3-content w3-section">
                <img class="mySlides2" src="{{ url('template/image/product_image/'.$product->product_image) }}" style="width:100%">
                <img class="mySlides2" src="{{ url('template/image/product_image/'.$product->product_image) }}" style="width:100%">
                <img class="mySlides2" src="{{ url('template/image/product_image/'.$product->product_image) }}" style="width:100%">
              </div>
            ...
            <div class="product_infor">
                ...
                <div class="procduct_detial">
                    <div class="tbl">
                        <table>
                            <tr class="row1">
                                <td class="row1_title"><strong>Dung tích</strong></td>  
                                <td><span>{{$product->product_capacity}}</span></td>
                            </tr>
                            <tr class="row1">
                                <td class="row1_title"><strong>Xuất xứ</strong></td>  
                                <td><span>{{$supplier->supplier_name}}</span></td>
                            </tr>
                            <tr class="row1">
                                <td class="row1_title"><strong>Hạn sử dụng</strong></td>  
                                <td><span>{{$product->product_expiry}}</span></td>
                            </tr>
                            <tr class="row1">
                                <td class="row1_title"><strong>Thành phần</strong></td>  
                                <td><span>{{$product->product_ingredient}}</span></td>
                            </tr>
                            <tr class="row1">
                                <td class="row1_title"><strong>Lưu ý sử dụng</strong></td>  
                                <td><span>{{$product->product_useNote}}</span></td>
                            </tr>
                        </table>
                    </div>
                            ...
                            <div class="boxwapp">
                                <div class="box2">
                                    <div class="price" style="float: right">
                                        ...
                                        <del>{{number_format($product->product_price_pre) }}VND</del>
                                    </div>
                                    ...
                                    <div class="counter" style="float: right">
                                        ...
                                        <input type="text" value="1" name="numproduct">
        ...
        <div class="prd_info parent_detail">
                        ...
                        <div class="product__img-block">
                            ...
                            <div class="img">
                                ...
                                <div class="pdt_icon">
                                    ...
                                    <a class="btn-buynow" title="Yêu thích">
                                        <div class="icon_list">
...
{{-- <script type="text/javascript">
    ...
    function increaseCount(a, b) {
      ...
      $('.parent_detail > .sub_detail').parent().click(function() {
  var submenu = $(this).children('.sub_detail');
