            ...
            <div class="layout-list-row layout-list-btn-wrap">
                ...
                <form method="POST" action="">
                    ...
                    <button class="btn_add">
                        <a class="btn btn-success" href="{{route('admin.news.add')}}">Thêm mới</a>
                    </button>
            ...
            <div class="layout-list-row">
                <table class="layout_table">
                    ...
                    <tr class="title_order">
                        ...
                        <td class="action_title1">Ngày đăng</td>                   
                    </tr>
                    @endif
                    @endif
            ...
            <div class="home-tab-content">
                ...
                <div class="layout-list-row">
                    <table class="layout_table">
                        ...
                        <tr>
                            <td>{{$item->id}}</td>
                            <td><div class="name_hiden">{{$item->news_title}}</div></td>

                            <td>{{date('d-m-Y', strtotime($item->updated_at))}}</td>
                            <td class="action_title">
                                <a class="btn btn-primary" href="{{route('admin.news.edit',['id'=>$item->id])}}">Cập nhật</a>
